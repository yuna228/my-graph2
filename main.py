...
with st.container(border=True):
    st.markdown("**이 그래프로 알 수 있는 것**")
    st.write(
        "상자 밖으로 표시되는 점에 마우스를 올리면 영화 이름과 장르, 영화를 본 관객의 수를 확인할 수 있다."
    )
# ==================================================
...
with st.container(border=True):
    st.markdown("**이 그래프로 알 수 있는 것**")
    st.write(
        "버블 크기를 통해 첫 주 관객 규모가 커짐에 따라서 얼마나 많은 관객들이 있었는지 확인이 가능하다."
    )
# ==================================================
# 7. 제작 국가 → 장르 선버스트 그래프
# ==================================================
...
with st.container(border=True):
    st.markdown("**이 그래프로 알 수 있는 것**")
    st.write(
        "미국에서 특히나 공포(호러) 영화가 많이 만들어졌음을 알 수 있고, "
        "다른 국가들의 공통점으로는 드라마 종류의 영화가 가장 많이 만들어졌다는 것을 알 수 있었다. "
    )
# ==================================================
